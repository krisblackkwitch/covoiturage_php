@extends('layouts.master')
			...
			<!-- start banner Area -->
			<section class="banner-area relative" id="home" style="background: url(img/3-Traits-to-Look-for-in-A-Call-Center-Employee.jpg) center; background-size: cover;">
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-end">
						<div class="banner-content col-lg-7 col-md-12">
							...
							<a href="#" class="primary-btn header-btn text-uppercase">Start Now</a>
						</div>												
					</div>
				</div>
			</section>
			...
			<section class="section-padding featured-list-news">
				<div class="container">
					<div class="text-center mb-80">
						...
						<h2 class="entry-title"><a href="#" style="">OVERVIEW</a></h2>
					</div>
					<div class="row">
						<div class="col-md-6">
							<article class="post-wrapper featured-news">
								<div class="thumb-wrapper waves-effect waves-block waves-light">
									<a href="#"><img src="img/service-bg.jpg" class="img-responsive" alt=""></a>
								</div>
							<div class="blog-content">
								<header class="entry-header-wrapper sticky">
									<div class="entry-header">
										<h2 class="entry-title"><a href="#">Overview1</a></h2>
								...
								<div class="entry-content">
									...
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="primary-btn mt-20 text-uppercase">Contact Us<span class="lnr lnr-arrow-right"></button>
								</div>
							</div>
						</article>
					</div>
						<div class="col-md-6">
							<article class="post-wrapper featured-news">
								<div class="thumb-wrapper waves-effect waves-block waves-light">
									<a href="#"><img src="img/blog-12.jpg" class="img-responsive" alt=""></a>
								</div>
							<div class="blog-content">
								<header class="entry-header-wrapper sticky">
									<div class="entry-header">
										<h2 class="entry-title"><a href="#">Overview2</a></h2>
										<div class="entry-meta">
								...
								<div class="entry-content">
									<p>Maecenas varius finibus orci vel dignissim. Nam posuere, magna pellentesque accumsan tincidunt, libero lorem.</p>
									<a href="#" class="readmore">Learn More <i class="fa fa-long-arrow-right"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<button class="primary-btn mt-20 text-uppercase">Sign Up<span class="lnr lnr-arrow-right"></button>
								</div>
							</div>
						</article>
					</div>
			...
			<section class="about-area" id="howitworks">
			...
			<section class="info-area" id="whyitworks">
				<div class="container-fluid">
					<div class="row d-flex justify-content-end align-items-center">
						<div class="col-lg-6 col-md-12 info-left no-padding">
							<img class="img-fluid" src="img/header-bg6.jpg" alt="">
						</div>
			...
			<!-- <section class="info-area" id="community">
				<div class="container-fluid">
					<div class="row d-flex justify-content-end align-items-center">
						<div class="col-lg-6 col-md-12 info-left no-padding" style="padding: 36px">
							<img class="img-fluid" src="img/782f3606-1ca0-4f9e-9024-57a27b636ae5.jpg" alt="">
						</div>
						<div class="col-lg-6 col-md-12 info-right no-padding">
							<h1>Our <br>
							Large Community</h1>
